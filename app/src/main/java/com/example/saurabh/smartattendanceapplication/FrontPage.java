...
public class FrontPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frntpage);
        ...
        ((TextView)findViewById(R.id.radioButton)).setTypeface(typeface);
        ((TextView)findViewById(R.id.radioButton2)).setTypeface(typeface);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_frntpage, menu);
        return true;
    }
